    ...
    es: {
        translations: {
            titles: {
                ...
                welcome: 'Bienvenido al Skin Gamer Token',
                days: 'dias',
                hours: 'horas',
                minutes: 'minutos',
                and: 'y',
                preSale: {
                    title: 'Preventa en',
                    completed: 'Preventa ya disponible'
                },
                launch: {
                    title: '',
                    subtitle: 'para el lanzamiento oficial',
                    completed: 'Disponible para compra'
                },
                menuDesktop: {
                    home: 'Comienzo',
                    buy: 'Compra',
                ...
                menuMobile: {
                    ...
                    roadmap: 'Roadmap',
                    nft: 'NFT (Pronto)',
                    platform: 'Plataforma Skin Token (Pronto)',
                    language: 'Idioma'
                }
            },
            messages: {
                ...
                modal: {
                    ...
                    comingSoon: {
                        title: 'Pronto',
                        text: 'Esta opción estará disponible pronto, siga nuestra hoja de ruta y síganos en las redes sociales para obtener más información.'
                    },
                    langOptions: {
                        title: 'Idioma',
                        english: 'English',
            ...
            buttons: {
                buyPcs: 'Compra en PancakeSwap',
                contractBcs: 'Contrato BCScan',
                whitepaper: 'Whitepaper',
                chartPoo: 'Gráfico en PooCoin'   
            },
            tokencomics: {
                title: 'Tokencomics',
                ...
                devTeam: '5% Equipo de Desarrollo',
                reward: '5% Recompensas',
                publicSale: '50% Venta al Publico'
            },
            roadmap: {
                title: 'Roadmap',
                phase1: {
